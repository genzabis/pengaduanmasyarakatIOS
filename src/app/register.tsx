...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, Alert, ActivityIndicator, Animated, SafeAreaView, KeyboardAvoidingView, Platform, ScrollView, Image, Dimensions } from 'react-native';
          ...
          <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            ...
            <Animated.View style={[styles.content, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
              ...
              <View style={styles.logoContainer}>
                ...
                <Text style={styles.subtitle}>Buat akun baru untuk mulai melapor</Text>
              </View>
